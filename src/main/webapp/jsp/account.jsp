...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
		...
		<div class="center">
			<div class="user-left">
				<div class="Account-infomation" id="accountInFO">
					<i class="iconfont icon-user"></i>
					<span>Account Information</span>
				</div>
				<div class="Account-infomation" id="tranHis">
					<i class="iconfont icon-car"></i>
					<span>Transaction History</span>
				</div>
				<div class="Account-infomation" id="addressBook">
					<i class="iconfont icon-069-address-book"></i>
					<span>Address Book</span>
				</div>
				<div class="Account-infomation" id="myCard">
					<i class="iconfont icon-cardvip"></i>
					<span>My Cards</span>
				</div>
				<div class="Account-infomation" id="myProductReview">
					<i class="iconfont icon-review"></i>
					<span>My Product Review</span>
				</div>
			</div>
			<div class="user-right">
				<iframe class="iframes" id="iframes" src="${pageContext.request.contextPath}/jsp/account-information.jsp"></iframe>
			</div>
	...
	<div id="block-copyrightblock" class="row">
		...
		$("#myAccountTitle").click(function(){
			 var u="${u.userName}"
				...
				if(u==""){
					alert("Please login");
					<% session.setAttribute("backUrl", "http://localhost:8080/coffee/jsp/account.jsp");
					   %>
		  ...
		  $("#cartTitle").click(function(){
			...
			$(".Account-infomation").first().children().css("color", "#532D6D");
			$(".Account-infomation").click(function() {
				$(".Account-infomation").children().css("color", "#8A8A8D");
				console.log($(this));
				$(this).children().css("color", "#532D6D");
			
		});
		$("#accountInFO").click(function() {
		var iframes = document.getElementById("iframes");
		iframes.src = "${pageContext.request.contextPath}/jsp/account-information.jsp";
	});
		$("#addressBook").click(function() {
		var iframes = document.getElementById("iframes");
		iframes.src = "${pageContext.request.contextPath}/jsp/addressBook.jsp";
	});
	
	$("#myProductReview").click(function() {
		var iframes = document.getElementById("iframes");
		iframes.src = "${pageContext.request.contextPath}/jsp/ProductReview.jsp";
	});
	$("#myCard").click(function() {
		var iframes = document.getElementById("iframes");
		iframes.src = "${pageContext.request.contextPath}/jsp/card.jsp";
	});
	$("#tranHis").click(function() {
		var iframes = document.getElementById("iframes");
		iframes.src = "${pageContext.request.contextPath}/jsp/transHistory.jsp";
	});
